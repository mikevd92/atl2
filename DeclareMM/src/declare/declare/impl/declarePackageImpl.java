...
public class declarePackageImpl extends EPackageImpl implements declarePackage {
	 ...
	 * @generated
	 */
	private EClass outputRelationEClass = null;
	 ...
	 * @generated
	 */
	private EClass specialConstraintEClass = null;
	 ...
	 * @generated
	 */
	public EReference getDeclare_ContainsInputRelations() {
		return (EReference)declareEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getDeclare_ContainsOutputRelations() {
		return (EReference)declareEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getDeclare_ContainsSpecialConstraints() {
		return (EReference)declareEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getInputRelation_InputRelationFromActivity() {
	 ...
	 * @generated
	 */
	public EReference getInputRelation_InputRelationToConstraint() {
		return (EReference)inputRelationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getOutputRelation() {
		return outputRelationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getOutputRelation_OutputRelationToActivity() {
		return (EReference)outputRelationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getOutputRelation_OutputRelationFromConstraint() {
		return (EReference)outputRelationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getSpecialConstraint() {
		return specialConstraintEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(declareEClass, DECLARE__CONTAINS_INPUT_RELATIONS);
		createEReference(declareEClass, DECLARE__CONTAINS_OUTPUT_RELATIONS);
		createEReference(declareEClass, DECLARE__CONTAINS_SPECIAL_CONSTRAINTS);
		...
		createEReference(inputRelationEClass, INPUT_RELATION__INPUT_RELATION_FROM_ACTIVITY);
		createEReference(inputRelationEClass, INPUT_RELATION__INPUT_RELATION_TO_CONSTRAINT);

		outputRelationEClass = createEClass(OUTPUT_RELATION);
		createEReference(outputRelationEClass, OUTPUT_RELATION__OUTPUT_RELATION_TO_ACTIVITY);
		createEReference(outputRelationEClass, OUTPUT_RELATION__OUTPUT_RELATION_FROM_CONSTRAINT);

		specialConstraintEClass = createEClass(SPECIAL_CONSTRAINT);
	}
	...
	public void initializePackageContents() {
		...
		choiceEClass.getESuperTypes().add(this.getSpecialConstraint());
		...
		initEReference(getDeclare_ContainsInputRelations(), this.getInputRelation(), null, "containsInputRelations", null, 0, -1, Declare.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDeclare_ContainsOutputRelations(), this.getOutputRelation(), null, "containsOutputRelations", null, 0, -1, Declare.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDeclare_ContainsSpecialConstraints(), this.getSpecialConstraint(), null, "containsSpecialConstraints", null, 0, -1, Declare.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInputRelation_InputRelationFromActivity(), this.getActivity(), null, "InputRelationFromActivity", null, 0, 1, InputRelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInputRelation_InputRelationToConstraint(), this.getSpecialConstraint(), null, "InputRelationToConstraint", null, 0, 1, InputRelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(outputRelationEClass, OutputRelation.class, "OutputRelation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOutputRelation_OutputRelationToActivity(), this.getActivity(), null, "OutputRelationToActivity", null, 0, -1, OutputRelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOutputRelation_OutputRelationFromConstraint(), this.getSpecialConstraint(), null, "OutputRelationFromConstraint", null, 0, 1, OutputRelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(specialConstraintEClass, SpecialConstraint.class, "SpecialConstraint", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
