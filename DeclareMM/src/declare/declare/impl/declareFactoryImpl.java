...
public class declareFactoryImpl extends EFactoryImpl implements declareFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case declarePackage.INPUT_RELATION: return createInputRelation();
			case declarePackage.OUTPUT_RELATION: return createOutputRelation();
			default:
	 ...
	 * @generated
	 */
	public OutputRelation createOutputRelation() {
		OutputRelationImpl outputRelation = new OutputRelationImpl();
