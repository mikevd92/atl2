...
public interface Constraint extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>To Activity</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>To Activity</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>To Activity</em>' reference.
	 * @see #setToActivity(Activity)
	...
	/**
	 * Sets the value of the '{@link declare.declare.Constraint#getToActivity <em>To Activity</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>To Activity</em>' reference.
	 * @see #getToActivity()
	 * @generated
	 */
	void setToActivity(Activity value);
