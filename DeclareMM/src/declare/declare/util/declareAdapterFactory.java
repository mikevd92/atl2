...
public class declareAdapterFactory extends AdapterFactoryImpl {
	...
	protected declareSwitch<Adapter> modelSwitch =
		new declareSwitch<Adapter>() {
			...
			@Override
			public Adapter caseOutputRelation(OutputRelation object) {
				return createOutputRelationAdapter();
			}
			@Override
			public Adapter caseSpecialConstraint(SpecialConstraint object) {
				return createSpecialConstraintAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link declare.declare.InputRelation <em>Input Relation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link declare.declare.OutputRelation <em>Output Relation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link declare.declare.SpecialConstraint <em>Special Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSpecialConstraintAdapter() {
		return null;
	}
