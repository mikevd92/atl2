 ...
 * @generated
 */
public class ExtPetriNetsDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ExtPetriNetsDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof extendedPetriNets.extendedPetriNets.diagram.navigator.ExtPetriNetsDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((extendedPetriNets.extendedPetriNets.diagram.navigator.ExtPetriNetsDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new extendedPetriNets.extendedPetriNets.diagram.navigator.ExtPetriNetsDomainNavigatorItem(
