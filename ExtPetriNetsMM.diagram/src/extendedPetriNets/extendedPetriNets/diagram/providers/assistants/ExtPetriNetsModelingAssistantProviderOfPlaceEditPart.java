 ...
 * @generated
 */
public class ExtPetriNetsModelingAssistantProviderOfPlaceEditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((extendedPetriNets.extendedPetriNets.diagram.edit.parts.PlaceEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			extendedPetriNets.extendedPetriNets.diagram.edit.parts.PlaceEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(extendedPetriNets.extendedPetriNets.diagram.edit.parts.PlaceEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((extendedPetriNets.extendedPetriNets.diagram.edit.parts.PlaceEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			extendedPetriNets.extendedPetriNets.diagram.edit.parts.PlaceEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(extendedPetriNets.extendedPetriNets.diagram.edit.parts.PlaceEditPart) targetEditPart,
				relationshipType);
	}
