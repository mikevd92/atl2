package extendedPetriNets.extendedPetriNets.diagram.parsers;
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							extendedPetriNets.extendedPetriNets.diagram.part.Messages.MessageFormatParser_InvalidInputError,
