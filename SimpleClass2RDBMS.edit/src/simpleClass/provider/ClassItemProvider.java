...
/**
 * This is the item provider adapter for a {@link simpleClass.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider extends ClassifierItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_persistent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_persistent_feature", "_UI_Class_type"),
				 SimpleClassPackage.Literals.CLASS__PERSISTENT,
				 true,
				 false,
				 false,
	...
	protected void addSuperPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_super_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_super_feature", "_UI_Class_type"),
				 SimpleClassPackage.Literals.CLASS__SUPER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimpleClassPackage.Literals.CLASS__ATTRIBUTES);
		}
	...
	public String getText(Object object) {
		String label = ((simpleClass.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(simpleClass.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimpleClassPackage.Literals.CLASS__ATTRIBUTES,
				 SimpleClassFactory.eINSTANCE.createAttribute()));
	}
