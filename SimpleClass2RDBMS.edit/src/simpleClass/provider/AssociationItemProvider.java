...
/**
 * This is the item provider adapter for a {@link simpleClass.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Association_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Association_name_feature", "_UI_Association_type"),
				 SimpleClassPackage.Literals.ASSOCIATION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimpleClassPackage.Literals.ASSOCIATION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimpleClassPackage.Literals.ASSOCIATION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Association.class)) {
			case SimpleClassPackage.ASSOCIATION__NAME:
