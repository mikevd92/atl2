 ...
 * @generated
 */
public class ResourcePetriNetsDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ResourcePetriNetsDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof resourcePetriNet.resourcePetriNet.diagram.navigator.ResourcePetriNetsDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((resourcePetriNet.resourcePetriNet.diagram.navigator.ResourcePetriNetsDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new resourcePetriNet.resourcePetriNet.diagram.navigator.ResourcePetriNetsDomainNavigatorItem(
