...
public class ResourceEditPart extends ShapeNodeEditPart {
	...
	public class ResourceFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureResourceNumberOfTokensFigure;
		...
		private void createContents() {
			...
			fFigureResourceNumberOfTokensFigure = new WrappingLabel();

			fFigureResourceNumberOfTokensFigure.setText("<...>");

			this.add(fFigureResourceNumberOfTokensFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureResourceNumberOfTokensFigure() {
			return fFigureResourceNumberOfTokensFigure;
		}
