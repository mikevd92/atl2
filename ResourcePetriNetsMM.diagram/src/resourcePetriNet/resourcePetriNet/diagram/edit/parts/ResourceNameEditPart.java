 ...
 * @generated
 */
public class ResourceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new resourcePetriNet.resourcePetriNet.diagram.edit.policies.ResourcePetriNetsTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = resourcePetriNet.resourcePetriNet.diagram.providers.ResourcePetriNetsParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					resourcePetriNet.resourcePetriNet.diagram.edit.parts.ResourcePetriNetsEditPartFactory
