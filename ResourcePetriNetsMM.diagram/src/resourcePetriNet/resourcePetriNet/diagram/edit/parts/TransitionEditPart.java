...
public class TransitionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new resourcePetriNet.resourcePetriNet.diagram.edit.policies.TransitionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof resourcePetriNet.resourcePetriNet.diagram.edit.parts.TransitionNameEditPart) {
			((resourcePetriNet.resourcePetriNet.diagram.edit.parts.TransitionNameEditPart) childEditPart)
