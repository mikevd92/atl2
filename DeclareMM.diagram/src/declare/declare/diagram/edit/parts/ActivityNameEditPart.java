...
import declare.declare.diagram.edit.policies.DeclareTextSelectionEditPolicy;
...
public class ActivityNameEditPart extends CompartmentEditPart implements
	 ...
	 * @generated
	 */
	public ActivityNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new DeclareTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return DeclareElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeclareParserProvider
					.getParser(
							DeclareElementTypes.Activity_2001,
							getParserElement(),
							DeclareVisualIDRegistry
									.getType(declare.declare.diagram.edit.parts.ActivityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					DeclareEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
