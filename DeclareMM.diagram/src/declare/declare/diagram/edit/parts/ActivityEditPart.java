...
import declare.declare.diagram.edit.policies.ActivityItemSemanticEditPolicy;
...
public class ActivityEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DeclareVisualIDRegistry
	...
	public class ActivityFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureActivityExistenceLabelFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureActivityInitFigure;
		...
		private void createContents() {
			...
			fFigureActivityExistenceLabelFigure = new WrappingLabel();

			fFigureActivityExistenceLabelFigure.setText("<...>");

			this.add(fFigureActivityExistenceLabelFigure);

			fFigureActivityInitFigure = new WrappingLabel();

			fFigureActivityInitFigure.setText("<...>");

			this.add(fFigureActivityInitFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureActivityExistenceLabelFigure() {
			return fFigureActivityExistenceLabelFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureActivityInitFigure() {
			return fFigureActivityInitFigure;
		}
