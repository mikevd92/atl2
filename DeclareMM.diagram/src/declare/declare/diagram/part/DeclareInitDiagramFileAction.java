 ...
 * @generated
 */
public class DeclareInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new DeclareNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				DeclareEditPart.MODEL_ID));
		DeclareDiagramEditorUtil.runWizard(getShell(), wizard,
