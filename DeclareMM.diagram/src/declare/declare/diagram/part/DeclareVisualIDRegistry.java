...
public class DeclareVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case DeclareEditPart.VISUAL_ID:
			...
			if (declare.declare.declarePackage.eINSTANCE.getChoice()
					.isSuperTypeOf(domainElement.eClass())) {
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (declare.declare.declarePackage.eINSTANCE.getInputRelation()
				.isSuperTypeOf(domainElement.eClass())) {
			return InputRelationEditPart.VISUAL_ID;
		}
		if (declare.declare.declarePackage.eINSTANCE.getOutputRelation()
				.isSuperTypeOf(domainElement.eClass())) {
			return OutputRelationEditPart.VISUAL_ID;
		}
