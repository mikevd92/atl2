...
public class DeclarePaletteFactory {
	...
	private PaletteContainer createDeclare1Group() {
		...
		paletteContainer.add(createInputRelation22CreationTool());
		paletteContainer.add(createOutputRelation23CreationTool());
	...
	private ToolEntry createRespondedExistence2CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.RespondedExistence_4001));
		entry.setId("createRespondedExistence2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.RespondedExistence_4001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCoExistence3CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections.singletonList(DeclareElementTypes.CoExistence_4009));
		entry.setId("createCoExistence3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.CoExistence_4009));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createResponse4CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections.singletonList(DeclareElementTypes.Response_4020));
		entry.setId("createResponse4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.Response_4020));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createPrecedence5CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections.singletonList(DeclareElementTypes.Precedence_4019));
		entry.setId("createPrecedence5CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.Precedence_4019));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createSuccession6CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections.singletonList(DeclareElementTypes.Succession_4021));
		entry.setId("createSuccession6CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.Succession_4021));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createAlternateResponse7CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.AlternateResponse_4005));
		entry.setId("createAlternateResponse7CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.AlternateResponse_4005));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createChainResponse9CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.ChainResponse_4007));
		entry.setId("createChainResponse9CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.ChainResponse_4007));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createChainSuccession10CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.ChainSuccession_4008));
		entry.setId("createChainSuccession10CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.ChainSuccession_4008));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createChainPrecedence11CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.ChainPrecedence_4006));
		entry.setId("createChainPrecedence11CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.ChainPrecedence_4006));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNotCoExistence12CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.NotCoExistence_4014));
		entry.setId("createNotCoExistence12CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.NotCoExistence_4014));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNotRespondedExistence13CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.NotRespondedExistence_4016));
		entry.setId("createNotRespondedExistence13CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.NotRespondedExistence_4016));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNotResponse14CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections.singletonList(DeclareElementTypes.NotResponse_4017));
		entry.setId("createNotResponse14CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.NotResponse_4017));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNotPrecedence15CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.NotPrecedence_4015));
		entry.setId("createNotPrecedence15CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.NotPrecedence_4015));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNotSuccession16CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.NotSuccession_4018));
		entry.setId("createNotSuccession16CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.NotSuccession_4018));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNotChainRepsonse17CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.NotChainRepsonse_4012));
		entry.setId("createNotChainRepsonse17CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.NotChainRepsonse_4012));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNotChainSuccessive18CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.NotChainSuccessive_4013));
		entry.setId("createNotChainSuccessive18CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.NotChainSuccessive_4013));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createNotChainPrecedence19CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.NotChainPrecedence_4011));
		entry.setId("createNotChainPrecedence19CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.NotChainPrecedence_4011));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createChoice20CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				...
				Collections.singletonList(DeclareElementTypes.Choice_2002));
		entry.setId("createChoice20CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.Choice_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createExclusiveChoice21CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				...
				Collections
						.singletonList(DeclareElementTypes.ExclusiveChoice_4010));
		entry.setId("createExclusiveChoice21CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.ExclusiveChoice_4010));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	 ...
	 * @generated
	 */
	private ToolEntry createInputRelation22CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				Messages.InputRelation22CreationTool_title,
				Messages.InputRelation22CreationTool_desc,
				Collections
						.singletonList(DeclareElementTypes.InputRelation_4002));
		entry.setId("createInputRelation22CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.InputRelation_4002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	 ...
	 * @generated
	 */
	private ToolEntry createOutputRelation23CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(
				Messages.OutputRelation23CreationTool_title,
				Messages.OutputRelation23CreationTool_desc,
				Collections
						.singletonList(DeclareElementTypes.OutputRelation_4003));
		entry.setId("createOutputRelation23CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DeclareElementTypes
				.getImageDescriptor(DeclareElementTypes.OutputRelation_4003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
