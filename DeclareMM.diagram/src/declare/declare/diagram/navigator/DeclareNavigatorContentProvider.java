	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case RespondedExistenceEditPart.VISUAL_ID: {
			...
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_RespondedExistence_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_RespondedExistence_4001_source,
		...
		case InputRelationEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_InputRelation_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_InputRelation_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ChoiceEditPart.VISUAL_ID));
		...
		case OutputRelationEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_OutputRelation_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_OutputRelation_4003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case AlternateResponseEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_AlternateResponse_4005_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_AlternateResponse_4005_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case ChainPrecedenceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_ChainPrecedence_4006_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_ChainPrecedence_4006_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case ChainResponseEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_ChainResponse_4007_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_ChainResponse_4007_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case ChainSuccessionEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_ChainSuccession_4008_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_ChainSuccession_4008_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case CoExistenceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_CoExistence_4009_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_CoExistence_4009_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case ExclusiveChoiceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_ExclusiveChoice_4010_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_ExclusiveChoice_4010_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case NotChainPrecedenceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotChainPrecedence_4011_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotChainPrecedence_4011_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case NotChainRepsonseEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotChainRepsonse_4012_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksSourceByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case NotChainSuccessiveEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotChainSuccessive_4013_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotChainSuccessive_4013_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case NotCoExistenceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotCoExistence_4014_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotCoExistence_4014_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case NotPrecedenceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotPrecedence_4015_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotPrecedence_4015_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case NotRespondedExistenceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotRespondedExistence_4016_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotRespondedExistence_4016_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case NotResponseEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotResponse_4017_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotResponse_4017_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case NotSuccessionEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotSuccession_4018_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_NotSuccession_4018_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case PrecedenceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_Precedence_4019_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_Precedence_4019_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case ResponseEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_Response_4020_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_Response_4020_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
		...
		case SuccessionEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DeclareNavigatorGroup target = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_Succession_4021_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DeclareNavigatorGroup source = new DeclareNavigatorGroup(
					Messages.NavigatorGroupName_Succession_4021_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DeclareVisualIDRegistry.getType(ActivityEditPart.VISUAL_ID));
