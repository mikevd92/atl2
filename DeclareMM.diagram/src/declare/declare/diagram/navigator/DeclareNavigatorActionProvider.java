...
import declare.declare.diagram.part.DeclareDiagramEditor;
 ...
 * @generated
 */
public class DeclareNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof DeclareNavigatorItem) {
					selectedElement = ((DeclareNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, DeclareDiagramEditor.ID);
