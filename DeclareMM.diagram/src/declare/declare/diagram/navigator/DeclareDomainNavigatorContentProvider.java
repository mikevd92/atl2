 ...
 * @generated
 */
public class DeclareDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public DeclareDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof DeclareDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((DeclareDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new DeclareDomainNavigatorItem((EObject) objects[i],
