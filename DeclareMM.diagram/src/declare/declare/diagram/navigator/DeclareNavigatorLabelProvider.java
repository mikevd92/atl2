...
public class DeclareNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case ChoiceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?platform:/resource/DeclareMM/model/Declare.ecore?Choice", DeclareElementTypes.Choice_2002); //$NON-NLS-1$
		case RespondedExistenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?RespondedExistence", DeclareElementTypes.RespondedExistence_4001); //$NON-NLS-1$
		case InputRelationEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?InputRelation", DeclareElementTypes.InputRelation_4002); //$NON-NLS-1$
		case OutputRelationEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?OutputRelation", DeclareElementTypes.OutputRelation_4003); //$NON-NLS-1$
		...
		case AlternateResponseEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?AlternateResponse", DeclareElementTypes.AlternateResponse_4005); //$NON-NLS-1$
		case ChainPrecedenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?ChainPrecedence", DeclareElementTypes.ChainPrecedence_4006); //$NON-NLS-1$
		case ChainResponseEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?ChainResponse", DeclareElementTypes.ChainResponse_4007); //$NON-NLS-1$
		case ChainSuccessionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?ChainSuccession", DeclareElementTypes.ChainSuccession_4008); //$NON-NLS-1$
		case CoExistenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?CoExistence", DeclareElementTypes.CoExistence_4009); //$NON-NLS-1$
		case ExclusiveChoiceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?ExclusiveChoice", DeclareElementTypes.ExclusiveChoice_4010); //$NON-NLS-1$
		case NotChainPrecedenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?NotChainPrecedence", DeclareElementTypes.NotChainPrecedence_4011); //$NON-NLS-1$
		case NotChainRepsonseEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?NotChainRepsonse", DeclareElementTypes.NotChainRepsonse_4012); //$NON-NLS-1$
		case NotChainSuccessiveEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?NotChainSuccessive", DeclareElementTypes.NotChainSuccessive_4013); //$NON-NLS-1$
		case NotCoExistenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?NotCoExistence", DeclareElementTypes.NotCoExistence_4014); //$NON-NLS-1$
		case NotPrecedenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?NotPrecedence", DeclareElementTypes.NotPrecedence_4015); //$NON-NLS-1$
		case NotRespondedExistenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?NotRespondedExistence", DeclareElementTypes.NotRespondedExistence_4016); //$NON-NLS-1$
		case NotResponseEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?NotResponse", DeclareElementTypes.NotResponse_4017); //$NON-NLS-1$
		case NotSuccessionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?NotSuccession", DeclareElementTypes.NotSuccession_4018); //$NON-NLS-1$
		case PrecedenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?Precedence", DeclareElementTypes.Precedence_4019); //$NON-NLS-1$
		case ResponseEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?Response", DeclareElementTypes.Response_4020); //$NON-NLS-1$
		case SuccessionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?platform:/resource/DeclareMM/model/Declare.ecore?Succession", DeclareElementTypes.Succession_4021); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		case RespondedExistenceEditPart.VISUAL_ID:
			return getRespondedExistence_4001Text(view);
		case InputRelationEditPart.VISUAL_ID:
			return getInputRelation_4002Text(view);
		case OutputRelationEditPart.VISUAL_ID:
			return getOutputRelation_4003Text(view);
		case AlternatePrecedenceEditPart.VISUAL_ID:
			return getAlternatePrecedence_4004Text(view);
		case AlternateResponseEditPart.VISUAL_ID:
			return getAlternateResponse_4005Text(view);
		case ChainPrecedenceEditPart.VISUAL_ID:
			return getChainPrecedence_4006Text(view);
		case ChainResponseEditPart.VISUAL_ID:
			return getChainResponse_4007Text(view);
		case ChainSuccessionEditPart.VISUAL_ID:
			return getChainSuccession_4008Text(view);
		case CoExistenceEditPart.VISUAL_ID:
			return getCoExistence_4009Text(view);
		case ExclusiveChoiceEditPart.VISUAL_ID:
			return getExclusiveChoice_4010Text(view);
		case NotChainPrecedenceEditPart.VISUAL_ID:
			return getNotChainPrecedence_4011Text(view);
		case NotChainRepsonseEditPart.VISUAL_ID:
			return getNotChainRepsonse_4012Text(view);
		case NotChainSuccessiveEditPart.VISUAL_ID:
			return getNotChainSuccessive_4013Text(view);
		case NotCoExistenceEditPart.VISUAL_ID:
			return getNotCoExistence_4014Text(view);
		case NotPrecedenceEditPart.VISUAL_ID:
			return getNotPrecedence_4015Text(view);
		case NotRespondedExistenceEditPart.VISUAL_ID:
			return getNotRespondedExistence_4016Text(view);
		case NotResponseEditPart.VISUAL_ID:
			return getNotResponse_4017Text(view);
		case NotSuccessionEditPart.VISUAL_ID:
			return getNotSuccession_4018Text(view);
		case PrecedenceEditPart.VISUAL_ID:
			return getPrecedence_4019Text(view);
		case ResponseEditPart.VISUAL_ID:
			return getResponse_4020Text(view);
		case SuccessionEditPart.VISUAL_ID:
			return getSuccession_4021Text(view);
		}
	 ...
	 * @generated
	 */
	private String getRespondedExistence_4001Text(View view) {
	 ...
	 * @generated
	 */
	private String getInputRelation_4002Text(View view) {
		return ""; //$NON-NLS-1$
	}
	 ...
	 * @generated
	 */
	private String getOutputRelation_4003Text(View view) {
		return ""; //$NON-NLS-1$
	}
	 ...
	 * @generated
	 */
	private String getAlternateResponse_4005Text(View view) {
	 ...
	 * @generated
	 */
	private String getChainPrecedence_4006Text(View view) {
	 ...
	 * @generated
	 */
	private String getChainResponse_4007Text(View view) {
	 ...
	 * @generated
	 */
	private String getChainSuccession_4008Text(View view) {
	 ...
	 * @generated
	 */
	private String getCoExistence_4009Text(View view) {
	 ...
	 * @generated
	 */
	private String getExclusiveChoice_4010Text(View view) {
	 ...
	 * @generated
	 */
	private String getNotChainPrecedence_4011Text(View view) {
	 ...
	 * @generated
	 */
	private String getNotChainRepsonse_4012Text(View view) {
	 ...
	 * @generated
	 */
	private String getNotChainSuccessive_4013Text(View view) {
	 ...
	 * @generated
	 */
	private String getNotCoExistence_4014Text(View view) {
	 ...
	 * @generated
	 */
	private String getNotPrecedence_4015Text(View view) {
	 ...
	 * @generated
	 */
	private String getNotRespondedExistence_4016Text(View view) {
	 ...
	 * @generated
	 */
	private String getNotResponse_4017Text(View view) {
	 ...
	 * @generated
	 */
	private String getNotSuccession_4018Text(View view) {
	 ...
	 * @generated
	 */
	private String getPrecedence_4019Text(View view) {
	 ...
	 * @generated
	 */
	private String getResponse_4020Text(View view) {
	 ...
	 * @generated
	 */
	private String getSuccession_4021Text(View view) {
