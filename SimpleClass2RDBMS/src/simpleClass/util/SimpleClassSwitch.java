 ...
 * @generated
 */
public class SimpleClassSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimpleClassPackage.CLASS_MODEL: {
				ClassModel classModel = (ClassModel)theEObject;
				T result = caseClassModel(classModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleClassPackage.CLASSIFIER: {
				Classifier classifier = (Classifier)theEObject;
				T result = caseClassifier(classifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleClassPackage.ASSOCIATION: {
				Association association = (Association)theEObject;
				T result = caseAssociation(association);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleClassPackage.CLASS: {
				simpleClass.Class class_ = (simpleClass.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = caseClassifier(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleClassPackage.PRIMITIVE_DATA_TYPE: {
			...
			case SimpleClassPackage.ATTRIBUTE: {
	 ...
	 * @generated
	 */
	public T caseClass(simpleClass.Class object) {
		return null;
	}
