package resourcePetriNet.resourcePetriNet.diagram.parsers;
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							resourcePetriNet.resourcePetriNet.diagram.part.Messages.MessageFormatParser_InvalidInputError,
