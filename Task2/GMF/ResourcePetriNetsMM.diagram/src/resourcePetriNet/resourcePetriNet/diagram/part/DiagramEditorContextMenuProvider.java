...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private resourcePetriNet.resourcePetriNet.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new resourcePetriNet.resourcePetriNet.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
