 ...
 * @generated
 */
public class ResourcePetriNetSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResourcePetriNetPackage.PLACE: {
			...
			case ResourcePetriNetPackage.PETRI_NET: {
				PetriNet petriNet = (PetriNet)theEObject;
				T result = casePetriNet(petriNet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcePetriNetPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcePetriNetPackage.INPUT_ARC: {
				InputArc inputArc = (InputArc)theEObject;
				T result = caseInputArc(inputArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcePetriNetPackage.OUTPUT_ARC: {
				OutputArc outputArc = (OutputArc)theEObject;
				T result = caseOutputArc(outputArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcePetriNetPackage.RESOURCE: {
				Resource resource = (Resource)theEObject;
				T result = caseResource(resource);
				if (result == null) result = caseGenericPlace(resource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcePetriNetPackage.GENERIC_PLACE: {
