...
/**
 * This is the item provider adapter for a {@link extendedPetriNets.extendedPetriNets.InputArc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 extendedPetriNetsPackage.Literals.INPUT_ARC__INPUT_ARC_TO_TRANSITION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 extendedPetriNetsPackage.Literals.INPUT_ARC__WEIGHT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 extendedPetriNetsPackage.Literals.INPUT_ARC__INPUT_ARC_FROM_PLACE,
				 true,
				 false,
				 true,
				 null,
