 ...
 * @generated
 */
public class OutputPortNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OutputPortNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new extendedPetriNets.extendedPetriNets.diagram.edit.policies.ExtPetriNetsTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = extendedPetriNets.extendedPetriNets.diagram.providers.ExtPetriNetsParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					extendedPetriNets.extendedPetriNets.diagram.edit.parts.ExtPetriNetsEditPartFactory
