...
public class TransitionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new extendedPetriNets.extendedPetriNets.diagram.edit.policies.TransitionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof extendedPetriNets.extendedPetriNets.diagram.edit.parts.TransitionNameEditPart) {
			((extendedPetriNets.extendedPetriNets.diagram.edit.parts.TransitionNameEditPart) childEditPart)
