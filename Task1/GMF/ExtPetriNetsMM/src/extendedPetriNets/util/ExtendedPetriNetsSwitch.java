/**
 */
package extendedPetriNets.util;
 ...
 * @generated
 */
public class ExtendedPetriNetsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ExtendedPetriNetsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtendedPetriNetsPackage.PETRI_NET: {
				PetriNet petriNet = (PetriNet)theEObject;
				T result = casePetriNet(petriNet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPetriNetsPackage.PLACE: {
				Place place = (Place)theEObject;
				T result = casePlace(place);
				if (result == null) result = caseGenericPlace(place);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPetriNetsPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPetriNetsPackage.INPUT_ARC: {
				InputArc inputArc = (InputArc)theEObject;
				T result = caseInputArc(inputArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPetriNetsPackage.OUTPUT_ARC: {
				OutputArc outputArc = (OutputArc)theEObject;
				T result = caseOutputArc(outputArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPetriNetsPackage.OUTPUT_PORT: {
				OutputPort outputPort = (OutputPort)theEObject;
				T result = caseOutputPort(outputPort);
				if (result == null) result = caseGenericPlace(outputPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPetriNetsPackage.INPUT_PORT: {
				InputPort inputPort = (InputPort)theEObject;
				T result = caseInputPort(inputPort);
				if (result == null) result = caseGenericPlace(inputPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtendedPetriNetsPackage.GENERIC_PLACE: {
				GenericPlace genericPlace = (GenericPlace)theEObject;
				T result = caseGenericPlace(genericPlace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Generic Place</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Generic Place</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGenericPlace(GenericPlace object) {
		return null;
	}
