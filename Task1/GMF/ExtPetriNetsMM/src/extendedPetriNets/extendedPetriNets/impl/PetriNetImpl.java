 ...
 * <ul>
 *   <li>{@link extendedPetriNets.extendedPetriNets.impl.PetriNetImpl#getName <em>Name</em>}</li>
 *   <li>{@link extendedPetriNets.extendedPetriNets.impl.PetriNetImpl#getContainsGenericPlaces <em>Contains Generic Places</em>}</li>
 *   <li>{@link extendedPetriNets.extendedPetriNets.impl.PetriNetImpl#getContainsTransitions <em>Contains Transitions</em>}</li>
 *   <li>{@link extendedPetriNets.extendedPetriNets.impl.PetriNetImpl#getContainsInputArcs <em>Contains Input Arcs</em>}</li>
 *   <li>{@link extendedPetriNets.extendedPetriNets.impl.PetriNetImpl#getContainsOutputArcs <em>Contains Output Arcs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	...
	protected EClass eStaticClass() {
		return extendedPetriNetsPackage.Literals.PETRI_NET;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, extendedPetriNetsPackage.PETRI_NET__NAME, oldName, name));
	}
	...
	public EList<GenericPlace> getContainsGenericPlaces() {
		if (containsGenericPlaces == null) {
			containsGenericPlaces = new EObjectContainmentEList<GenericPlace>(GenericPlace.class, this, extendedPetriNetsPackage.PETRI_NET__CONTAINS_GENERIC_PLACES);
		}
	...
	public EList<Transition> getContainsTransitions() {
		if (containsTransitions == null) {
			containsTransitions = new EObjectContainmentEList<Transition>(Transition.class, this, extendedPetriNetsPackage.PETRI_NET__CONTAINS_TRANSITIONS);
		}
	...
	public EList<InputArc> getContainsInputArcs() {
		if (containsInputArcs == null) {
			containsInputArcs = new EObjectContainmentEList<InputArc>(InputArc.class, this, extendedPetriNetsPackage.PETRI_NET__CONTAINS_INPUT_ARCS);
		}
	...
	public EList<OutputArc> getContainsOutputArcs() {
		if (containsOutputArcs == null) {
			containsOutputArcs = new EObjectContainmentEList<OutputArc>(OutputArc.class, this, extendedPetriNetsPackage.PETRI_NET__CONTAINS_OUTPUT_ARCS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case extendedPetriNetsPackage.PETRI_NET__CONTAINS_GENERIC_PLACES:
				return ((InternalEList<?>)getContainsGenericPlaces()).basicRemove(otherEnd, msgs);
			case extendedPetriNetsPackage.PETRI_NET__CONTAINS_TRANSITIONS:
				return ((InternalEList<?>)getContainsTransitions()).basicRemove(otherEnd, msgs);
			case extendedPetriNetsPackage.PETRI_NET__CONTAINS_INPUT_ARCS:
				return ((InternalEList<?>)getContainsInputArcs()).basicRemove(otherEnd, msgs);
			case extendedPetriNetsPackage.PETRI_NET__CONTAINS_OUTPUT_ARCS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case extendedPetriNetsPackage.PETRI_NET__NAME:
				return getName();
			case extendedPetriNetsPackage.PETRI_NET__CONTAINS_GENERIC_PLACES:
