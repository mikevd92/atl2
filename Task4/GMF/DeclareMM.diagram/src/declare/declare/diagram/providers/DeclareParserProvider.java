...
import declare.declare.diagram.parsers.MessageFormatParser;
import declare.declare.diagram.part.DeclareVisualIDRegistry;

/**
 * @generated
 */
public class DeclareParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	private IParser getActivityName_5001Parser() {
		if (activityName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { declare.declare.declarePackage.eINSTANCE
					.getActivity_Name() };
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(DeclareVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(DeclareVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (DeclareElementTypes.getElement(hint) == null) {
				return false;
			}
