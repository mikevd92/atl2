 ...
 * @generated
 */
public class NotSuccessionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NotSuccessionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof NotSuccession) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotSuccession_4014(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotSuccession_4014(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected NotSuccession getLink() {
		return (NotSuccession) getElementToEdit();
	}
