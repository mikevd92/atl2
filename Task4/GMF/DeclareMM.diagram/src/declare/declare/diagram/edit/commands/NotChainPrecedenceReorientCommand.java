 ...
 * @generated
 */
public class NotChainPrecedenceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NotChainPrecedenceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof NotChainPrecedence) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotChainPrecedence_4008(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotChainPrecedence_4008(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected NotChainPrecedence getLink() {
		return (NotChainPrecedence) getElementToEdit();
	}
