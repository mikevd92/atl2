 ...
 * @generated
 */
public class SuccessionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SuccessionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Succession) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSuccession_4015(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSuccession_4015(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Succession getLink() {
		return (Succession) getElementToEdit();
	}
