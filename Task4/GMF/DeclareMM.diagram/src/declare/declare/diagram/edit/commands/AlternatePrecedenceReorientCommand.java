 ...
 * @generated
 */
public class AlternatePrecedenceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AlternatePrecedenceReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof AlternatePrecedence) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAlternatePrecedence_4004(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAlternatePrecedence_4004(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected AlternatePrecedence getLink() {
		return (AlternatePrecedence) getElementToEdit();
	}
