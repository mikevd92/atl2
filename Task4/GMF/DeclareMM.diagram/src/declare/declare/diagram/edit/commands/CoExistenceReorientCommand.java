 ...
 * @generated
 */
public class CoExistenceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CoExistenceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof CoExistence) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCoExistence_4006(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistCoExistence_4006(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected CoExistence getLink() {
		return (CoExistence) getElementToEdit();
	}
