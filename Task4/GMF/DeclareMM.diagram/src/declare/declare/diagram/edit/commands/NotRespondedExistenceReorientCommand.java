 ...
 * @generated
 */
public class NotRespondedExistenceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NotRespondedExistenceReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof NotRespondedExistence) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotRespondedExistence_4012(container, getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected NotRespondedExistence getLink() {
		return (NotRespondedExistence) getElementToEdit();
	}
