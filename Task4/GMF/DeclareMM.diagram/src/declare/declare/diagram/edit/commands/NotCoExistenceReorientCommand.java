 ...
 * @generated
 */
public class NotCoExistenceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NotCoExistenceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof NotCoExistence) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotCoExistence_4010(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotCoExistence_4010(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected NotCoExistence getLink() {
		return (NotCoExistence) getElementToEdit();
	}
