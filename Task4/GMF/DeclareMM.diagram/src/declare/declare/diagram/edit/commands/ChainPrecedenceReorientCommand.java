 ...
 * @generated
 */
public class ChainPrecedenceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ChainPrecedenceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ChainPrecedence) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistChainPrecedence_4019(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistChainPrecedence_4019(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ChainPrecedence getLink() {
		return (ChainPrecedence) getElementToEdit();
	}
