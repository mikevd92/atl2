 ...
 * @generated
 */
public class NotChainRepsonseReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NotChainRepsonseReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof NotChainRepsonse) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotChainRepsonse_4009(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotChainRepsonse_4009(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected NotChainRepsonse getLink() {
		return (NotChainRepsonse) getElementToEdit();
	}
