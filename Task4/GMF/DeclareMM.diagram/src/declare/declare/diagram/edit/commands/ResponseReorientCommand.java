 ...
 * @generated
 */
public class ResponseReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ResponseReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Response) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistResponse_4016(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistResponse_4016(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Response getLink() {
		return (Response) getElementToEdit();
	}
