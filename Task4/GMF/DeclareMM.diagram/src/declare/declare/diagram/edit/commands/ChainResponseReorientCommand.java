 ...
 * @generated
 */
public class ChainResponseReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ChainResponseReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ChainResponse) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistChainResponse_4020(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistChainResponse_4020(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ChainResponse getLink() {
		return (ChainResponse) getElementToEdit();
	}
