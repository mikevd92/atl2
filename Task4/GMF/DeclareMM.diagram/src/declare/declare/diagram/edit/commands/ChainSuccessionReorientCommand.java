 ...
 * @generated
 */
public class ChainSuccessionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ChainSuccessionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ChainSuccession) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistChainSuccession_4021(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistChainSuccession_4021(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ChainSuccession getLink() {
		return (ChainSuccession) getElementToEdit();
	}
