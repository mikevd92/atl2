 ...
 * @generated
 */
public class ExclusiveChoiceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ExclusiveChoiceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ExclusiveChoice) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistExclusiveChoice_4007(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistExclusiveChoice_4007(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ExclusiveChoice getLink() {
		return (ExclusiveChoice) getElementToEdit();
	}
