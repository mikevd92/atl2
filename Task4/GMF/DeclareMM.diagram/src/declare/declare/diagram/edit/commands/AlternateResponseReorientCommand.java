 ...
 * @generated
 */
public class AlternateResponseReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AlternateResponseReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof AlternateResponse) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAlternateResponse_4022(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAlternateResponse_4022(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected AlternateResponse getLink() {
		return (AlternateResponse) getElementToEdit();
	}
