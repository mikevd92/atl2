 ...
 * @generated
 */
public class NotResponseReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NotResponseReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof NotResponse) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotResponse_4013(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotResponse_4013(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected NotResponse getLink() {
		return (NotResponse) getElementToEdit();
	}
