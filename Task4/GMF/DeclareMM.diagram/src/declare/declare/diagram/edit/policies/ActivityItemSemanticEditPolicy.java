...
import declare.declare.diagram.edit.commands.ChoiceReorientCommand;
...
public class ActivityItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DeclareVisualIDRegistry.getVisualID(incomingLink) == ChoiceEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (DeclareVisualIDRegistry.getVisualID(incomingLink) == NotChainRepsonseEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DeclareVisualIDRegistry.getVisualID(outgoingLink) == ChoiceEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (DeclareElementTypes.RespondedExistence_4003 == req.getElementType()) {
		...
		if (DeclareElementTypes.Choice_4005 == req.getElementType()) {
			return getGEFWrapper(new ChoiceCreateCommand(req, req.getSource(),
					req.getTarget()));
		}
		if (DeclareElementTypes.CoExistence_4006 == req.getElementType()) {
			return getGEFWrapper(new CoExistenceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.ExclusiveChoice_4007 == req.getElementType()) {
			return getGEFWrapper(new ExclusiveChoiceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.NotChainPrecedence_4008 == req.getElementType()) {
			return getGEFWrapper(new NotChainPrecedenceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.NotChainRepsonse_4009 == req.getElementType()) {
			return getGEFWrapper(new NotChainRepsonseCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.NotCoExistence_4010 == req.getElementType()) {
			return getGEFWrapper(new NotCoExistenceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.NotPrecedence_4011 == req.getElementType()) {
			return getGEFWrapper(new NotPrecedenceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.NotRespondedExistence_4012 == req
				.getElementType()) {
			return getGEFWrapper(new NotRespondedExistenceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.NotResponse_4013 == req.getElementType()) {
			return getGEFWrapper(new NotResponseCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.NotSuccession_4014 == req.getElementType()) {
			return getGEFWrapper(new NotSuccessionCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.Succession_4015 == req.getElementType()) {
			return getGEFWrapper(new SuccessionCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.Response_4016 == req.getElementType()) {
			return getGEFWrapper(new ResponseCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.Precedence_4017 == req.getElementType()) {
			return getGEFWrapper(new PrecedenceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.NotChainSuccessive_4018 == req.getElementType()) {
			return getGEFWrapper(new NotChainSuccessiveCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.ChainPrecedence_4019 == req.getElementType()) {
			return getGEFWrapper(new ChainPrecedenceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.ChainResponse_4020 == req.getElementType()) {
			return getGEFWrapper(new ChainResponseCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.ChainSuccession_4021 == req.getElementType()) {
			return getGEFWrapper(new ChainSuccessionCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (DeclareElementTypes.AlternateResponse_4022 == req.getElementType()) {
