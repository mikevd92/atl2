 ...
 * @generated
 */
public class NotPrecedenceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NotPrecedenceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof NotPrecedence) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotPrecedence_4011(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Declare container = (Declare) getLink().eContainer();
		return DeclareBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNotPrecedence_4011(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected NotPrecedence getLink() {
		return (NotPrecedence) getElementToEdit();
	}
